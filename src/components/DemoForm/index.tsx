...
const DemoForm: React.FC<FormProps> = ({ fill, check, filled, checked, submit, value }) => {
  return (
    <DemoFormStyled>
        ...
        <Paragraph>
          Questions? Go to <a href="https://github.com/mikaelvesavuori/figmagic">https://github.com/mikaelvesavuori/figmagic</a>. Pull requests, ideas and discussion is appreciated!
				</Paragraph>
        ...
        <Microcopy>
          ...
          Bezos or Zuckerberg...
				...
				<Checkbox required disabled={!filled} check={() => check()} />

				<Button disabled={!(checked && filled)}>Submit</Button>
      </Form>
    </DemoFormStyled>
  );
};
